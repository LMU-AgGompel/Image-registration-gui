...
def start_image_annotation_GUI(main_window_size = (1200,1100), graph_canvas_width = 700):
    """
    Parameters
    ----------
    ...
    Initialize the image annotation graphical interface and runs the main loop.
